...
class Main < Activity
  ...
  def on_create
      ...
      V('#qrcode').on(:click) do |view|
        integrator = Java::com.droiuby.client.core.utils.intents.IntentIntegrator.new(me)
  ...
  def on_activity_result(request_code, result_code, intent)
    app_url = V('#app_url')
    scanResult = Java::com.droiuby.client.core.utils.intents.IntentIntegrator.parseActivityResult(request_code, result_code, intent.native)
    if scanResult != nil
